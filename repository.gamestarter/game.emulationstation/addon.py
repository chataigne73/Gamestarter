...
if command == 'DOWNLOAD_THEMES':
	...
	if os.path.isdir(directory+"/emulationstation") == True: 
		...
		os.system("chmod a+x /storage/.kodi/addons/game.emulationstation/game.emulationstation-WeTek_Core")
	 	os.system("chmod a+x /storage/.kodi/addons/game.emulationstation/addon.sh && chmod a+x /storage/.kodi/addons/game.retroarch/addon.start && chmod a+x /storage/.kodi/addons/game.retroarch/game.retroarch-RPi && chmod a+x /storage/.kodi/addons/game.retroarch/game.retroarch-Gen && chmod a+x /storage/.kodi/addons/game.retroarch/game.retroarch-WeTek_Core")
	 	# xbmcgui.Dialog().ok(addonname, "Done. Copy your roms, reboot and enjoy!")
	 	#renombrar la carpeta de libs para el device
	 	os.system("PROJECT=$(head -c 3 /etc/release) && if [[ $PROJECT == 'WeT' ]] ; then mv -n /storage/.kodi/addons/game.emulationstation/lib-WeTek_Core /storage/.kodi/addons/game.emulationstation/lib ; else mv -n /storage/.kodi/addons/game.emulationstation/lib-RPi /storage/.kodi/addons/game.emulationstation/lib ; fi && echo 'EmulationStation [ADDON] :: '$PROJECT >> /storage/.kodi/temp/emulationstation.log")
	 	# if project in "Pi":
